...
class BoardPageItemView : LinearLayout {
    ...
    private fun init() {
        ...
        markLabel = com.kota.telnetUI.textView.TelnetTextViewSmall(context).apply {
            id = R.id.BoardPage_ItemView_mark
        ...
        gyTitleLabel = com.kota.telnetUI.textView.TelnetTextViewSmall(context).apply {
            id = R.id.BoardPage_ItemView_GY_Title
            layoutParams = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT).apply {
                marginStart = dp(12f)
            }
        ...
        metaRow.addView(gyTitleLabel)

        gyLabel = com.kota.telnetUI.textView.TelnetTextViewSmall(context).apply {
            id = R.id.BoardPage_ItemView_GY
            layoutParams = LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT)
            setTextColor(getThemeColor(R.attr.bahamut_boardItemGyColor))
        }
        metaRow.addView(gyLabel)
