...
public class ArticleExpressionListPage extends TelnetPage implements BlockListClickListener {
    EditText _inputField;

    BlockListAdapter articleExpressionListAdapter;
    // 按下新增
    ...
    private List<String> _articleExpressionsList = new ArrayList<>();
    ...
    public void onPageDidLoad() {
        ...
        articleExpressionListAdapter = new BlockListAdapter(_articleExpressionsList);
    ...
    private void reload() {
        List<String> _temp = Arrays.asList(UserSettings.getArticleExpressions());
    ...
    public void onBlockListPage_ItemView_delete_clicked(BlockListViewHolder blockListPage_ItemView) {
        ...
        List<String> new_list = ArticleExpressionListPage.this._articleExpressionsList;
