...
class ClassPage : TelnetListPage(), View.OnClickListener, Dialog_SearchBoard_Listener {
    ...
    override fun onSearchButtonClickedWithKeyword(keyword: String?) {
        SearchBoard_Handler.instance.clear()
    ...
    fun onSearchBoardFinished() {
        ...
        ASListDialog.createDialog().addItems(SearchBoard_Handler.instance.boards)
            .setListener(object : ASListDialogItemClickListener {
                override fun onListDialogItemClicked(
                    ...
                    val board = SearchBoard_Handler.instance.getBoard(index)
