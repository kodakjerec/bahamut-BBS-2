...
public class ASProcessingDialog extends ASDialog {
    ...
    public static ASProcessingDialog _instance = null;
    ...
    public static void showProcessingDialog(String aMessage) {
        showProcessingDialog(aMessage, (ASProcessingDialogOnBackDelegate) null);
    }
    ...
    private View buildContentView() {
        ...
        content_view.setPadding(padding, padding, padding, (int) TypedValue.applyDimension(1, 10.0f, getContext().getResources().getDisplayMetrics()));
        ...
        this._progress_bar.setPadding(0, 0, 0, (int) TypedValue.applyDimension(1, 10.0f, getContext().getResources().getDisplayMetrics()));
