...
public class ASNavigationController extends Activity {
  ...
  /* loaded from: classes.dex */
  public abstract static class PageCommand {
  ...
  public void removePageView(final ASViewController aPage, Animation aAnimation) {
    aAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.kumi.ASFramework.PageController.ASNavigationController.3
  ...
  public void animatePopViewController(final ASViewController aRemovePage, final ASViewController aAddPage, boolean animated) {
    ...
    new ASNavigationControllerPopAnimation(aRemovePage, aAddPage) { // from class: com.kumi.ASFramework.PageController.ASNavigationController.4
      @Override // com.kumi.ASFramework.PageController.ASNavigationControllerPopAnimation
  ...
  public void animatedPushViewController(final ASViewController sourceController, final ASViewController targetController, boolean animated) {
    ...
    new ASNavigationControllerPushAnimation(sourceController, targetController) { // from class: com.kumi.ASFramework.PageController.ASNavigationController.5
      @Override // com.kumi.ASFramework.PageController.ASNavigationControllerPushAnimation
      public void onAnimationFinished() {
        if (sourceController != null) {
  ...
  public void pushViewController(final ASViewController aController, boolean animated) {
    PageCommand command = new PageCommand() {
      ...
      @Override // com.kumi.ASFramework.PageController.ASNavigationController.PageCommand
      public void run() {
        if (aController != null) {
  ...
  public void popViewController(boolean animated) {
    PageCommand command = new PageCommand() { // from class: com.kumi.ASFramework.PageController.ASNavigationController.7
      @Override // com.kumi.ASFramework.PageController.ASNavigationController.PageCommand
      public void run() {
  ...
  public void exchangeViewControllers(final boolean animated) {
    new ASRunner() { // from class: com.kumi.ASFramework.PageController.ASNavigationController.10
      @Override // com.kumi.ASFramework.Thread.ASRunner
      public void run() {
        ASViewController source_controller = ASNavigationController.this._controllers.size() > 0 ? ASNavigationController.this._controllers.lastElement() : null;
        ASViewController target_controller = ASNavigationController.this._temp_controllers.size() > 0 ? ASNavigationController.this._temp_controllers.lastElement() : null;
