...
class this._cls0
    implements android.view.animation.hAnimation._cls2
{
    ...
    public void onAnimationEnd(Animation animation)
    {
        ...
        {
            ASNavigationControllerPushAnimation.access$300(ASNavigationControllerPushAnimation.this).getPageView().onPageAnimationFinished();
            ASNavigationControllerPushAnimation.access$402(ASNavigationControllerPushAnimation.this, true);
