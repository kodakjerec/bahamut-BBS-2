...
class this._cls0
    implements android.view.animation.pAnimation._cls1
{
    ...
    public void onAnimationEnd(Animation animation)
    {
        ...
        {
            ASNavigationControllerPopAnimation.access$000(ASNavigationControllerPopAnimation.this).getPageView().onPageAnimationFinished();
            ASNavigationControllerPopAnimation.access$102(ASNavigationControllerPopAnimation.this, true);
